...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Household and family expense tracking with imports, recurring bills, trips, budgets, and an AI assistant." },
      { property: "og:title", content: "Family Expense Tracker" },
